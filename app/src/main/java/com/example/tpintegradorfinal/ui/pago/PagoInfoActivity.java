...
public class PagoInfoActivity extends AppCompatActivity {

    private PagoViewModel AlquilerVM;
    ...
    public void cargarVistas(){
        ...
        AlquilerVM = ViewModelProvider.AndroidViewModelFactory.getInstance(getApplication()).create(PagoViewModel.class);
